...
const banners = [
  {
    ...
    description: "Cuide da sua saúde com os melhores produtos",
    cta: "Ver ofertas",
  ...
  },
  {
    ...
    subtitle: "Novidades na loja",
    description: "As melhores marcas para sua pele",
    cta: "Explorar",
  ...
  },
  {
    ...
    description: "Mesma eficácia, preço mais acessível",
    cta: "Saiba mais",
    href: "/categoria/genericos",
    bg: "from-[#5ba3e8] to-[#2B7DD4]",
    accent: "#ffffff",
  },
];
