...
export default function ConversasPage() {
  ...
  async function encerrar(id: string) {
    if (!confirm("Encerrar e apagar esta conversa?")) return;
        ...
        <div className="flex-1 overflow-y-auto">
          ...
          {conversas.map((c) => (
            <button
              ...
              className={`w-full text-left px-4 py-3 border-b border-gray-50 hover:bg-gray-50 transition-colors ${selected === c.id ? "bg-green-50 border-l-2 border-l-green-500" : ""}`}
            >
