...
export default function CarrosselToggles({ products: initial }: Props) {
  ...
  async function toggle(id: string, field: "in_promo" | "in_bestseller", value: boolean) {
  ...
  return (
    <div>
      <div className="flex gap-4 mb-6 text-sm text-[#718096]">
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-[#e2e8f0] bg-[#f8fafc]">
              ...
              <th className="text-center px-4 py-3 text-xs font-semibold text-[#718096] uppercase tracking-wide w-44">🏷️ Promoção</th>
              <th className="text-center px-4 py-3 text-xs font-semibold text-[#718096] uppercase tracking-wide w-44">⭐ Mais Vendidos</th>
            </tr>
          </thead>
